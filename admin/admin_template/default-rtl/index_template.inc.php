...
<head>
    ...
    <link href="<?php echo SWB; ?>css/bootstrap.rtl.css?<?php echo date('this') ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo SWB; ?>css/core.rtl.css?<?php echo date('this') ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo JWB; ?>colorbox/colorbox.css?<?php echo date('this') ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo JWB; ?>chosen/chosen.rtl.css?<?php echo date('this') ?>" rel="stylesheet" type="text/css" />
    ...
    <script type="text/javascript" src="<?php echo JWB; ?>chosen/chosen.jquery.rtl.js"></script>
